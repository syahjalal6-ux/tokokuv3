      ...
      <div className="container">
        ...
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px', maxWidth: 720, margin: '0 auto' }}>
            ...
            <motion.div
              variants={fadeUpVariant}
              whileHover={{ scale: 1.02, boxShadow: '0 8px 32px rgba(91,138,245,0.25)' }}
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          10 seller pertama dapat Pro gratis selamanya · Setup 2 menit · Tidak perlu kartu kredit
        </motion.p>
        ...
        <div key={i} className="glass-card" style={{ borderRadius: 'var(--radius-lg)', overflow: 'hidden', padding: 0 }}>
          ...
          {openFaq === i && (
            <motion.div
              ...
              style={{ padding: '12px 18px 16px', borderTop: `1px solid ${c.border}` }}
            >
