      ...
      <div style={{ maxWidth: 960, margin: '0 auto' }}>
        ...
        <div className="glass-card" style={{ padding: 'clamp(20px, 4vw, 32px)' }}>
          ...
          <div style={{ textAlign: 'center', marginTop: '24px' }}>
            <a href={waLink} target="_blank" rel="noreferrer" className="btn btn-primary" style={{ width: '100%', maxWidth: 360, justifyContent: 'center' }}>
              <MessageCircle size={15} /> Upgrade Sekarang — {CONFIG.PRO_PRICE}
            </a>
          </div>
        </div>
